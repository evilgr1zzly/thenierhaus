...
figlet -f Bloody Insta-Hack | lolcat
    ...
    echo " "
    echo -e "$Red                                 ⫸ Coded by$Yellow evilgr1zzly#1337$Red ⫷\033[0m"
    echo -e "$Red                               ⫸$Purple thenierhaus#1337$Red ⫷\033[0m"
echo " "
echo -e " $Green     |---------------------------------------------------------------------|"
echo -e " $Green     ||----------------------------$Cyan [features] $Green---------------------------||"
echo -e " $Green     ||                                                                   ||"
echo -e " $Green     ||             $Purple==>$Yellow[1️⃣] Instagram information gathering$Green                    ||"
echo -e " $Green     ||             $Purple==>️$Yellow[2️⃣] Instagram brute force attack$Green                       ||"
echo -e " $Green     ||             $Purple==>$Yellow[3️⃣] Instagram Auto Reporter$Green                            ||"
